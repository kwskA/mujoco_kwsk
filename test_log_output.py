...
def main():
    ...
    save_dir = ROOT_DIR / "test_results" / "log_output"

    writer = CSVLogWriter(save_dir=str(save_dir))
    writer.write_all(sim_log)
    ...
    print("\ncreated files:")
    print("-", save_dir / "kinematics.csv")
    print("-", save_dir / "muscles.csv")
    print("-", save_dir / "objectives.csv")
